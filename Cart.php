            ...
            <div class="navbar navbar-inverse navbar-fixed-top">
		        ...
		        <button type="submit" class="btn btn-primary" name="search" value="search" id="search_btn"><span class="glyphicon glyphicon-search"></span></button>
                        ...
                        <ul class="nav navbar-nav navbar-right">                            
                            ...
                            <li class="dropdown"><?php if(!isset($_SESSION['customer_id'])){     echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>SignIn</a>
							...
							<div class="panel panel-success">
								...
								<div class="panel-heading">
										...
										<p><br/></p>
                                                                                ...
                                                                                <div><a href="RegistrationPage.php?register=1">Create a new account?</a></div>
                                                                    </form>
								</div>
		...
		<div class="row">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
                                                    <center>
                                                        <div class="col-md-1 col-xs-1"><b>Sl.No</b></div>
							<div class="col-md-2 col-xs-2"><b>Action</b></div>
							<div class="col-md-1 col-xs-1"><b>Product Image</b></div>
							<div class="col-md-2 col-xs-2"><b>Product Name</b></div>
							<div class="col-md-2 col-xs-2"><b>Quantity</b></div>
							<div class="col-md-2 col-xs-2"><b>Product Price In ৳</b></div>
							<div class="col-md-2 col-xs-2"><b>Total Price In ৳</b></div>
                                                    </center>
						</div>
						<div id="cart_checkout" style="margin-top: 15px;"></div>												</div> 
					</div>
					<div class="panel-footer"></div>				
			</div>
